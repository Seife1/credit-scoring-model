...
import pandas as pd
import numpy as np
from scripts.data_preprocessing import CreditRiskEDA
...
class TestCreditRiskEDA(unittest.TestCase):
    ...
    def test_plot_numerical_distribution(self):
        ...
        try:
            self.eda.plot_numerical_distribution(['Age', 'Income', 'SpendingScore', 'TransactionCount'])
            self.assertTrue(True)  # If no error occurs, the test passes
        except Exception as e:
    ...
    def test_detect_outliers(self):
        ...
        try:
            self.eda.detect_outliers(['Age', 'Income', 'SpendingScore', 'TransactionCount'])
            self.assertTrue(True)  # If no error occurs, the test passes
        except Exception as e:
